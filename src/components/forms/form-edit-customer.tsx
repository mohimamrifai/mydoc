...
export const FormEditCustomer = ({ data }: FormEditCustomerProps) => {
    ...
    const onSubmit = async (formData: z.infer<typeof formSchema>) => {
        const formattedData = {
            ...
            ...(formData.newPassword === "" && { newPassword: undefined })
        }

        try {
            const result = await updateAccount(data.id, formattedData)
            if (result.success) {
