...
import AdministratorDashboard, { AdministratorDashboardProps } from "@/components/shared/administrator-dashboard";
...
export default async function AdminPage() {
  ...
  const formattedData: AdministratorDashboardProps = {
    medicalStaff: {
  ...
  return (
    <div className="space-y-6 px-2 mt-2">
      <AdministratorDashboard {...formattedData} />
    </div>
  );
}
